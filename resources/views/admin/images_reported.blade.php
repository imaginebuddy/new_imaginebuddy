	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
			...
			<div class="card shadow-custom border-0">
               ...
               @if ($data->count() !=  0)
                 ...
                 @foreach ($data as $report)
                   <tr>
                     ...
                     <td><a href="{{ url('prompt', $report->image()->id) }}" target="_blank">{{ str_limit($report->image()->title, 10, '...') }} <i class="bi-box-arrow-up-right"></i></a></td>
               ...
               {!! Form::button('<i class="bi-trash-fill"></i>', ['class' => 'btn btn-link text-danger e-none fs-5 p-0 actionDelete']) !!}
