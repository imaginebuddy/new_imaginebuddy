...
<div class="content">
	<div class="row">
      ...
      @include('errors.errors-forms')
			...
			<div class="card shadow-custom border-0">
				...
				@if (isset($data->user()->name))
					{{-- Approve Donation --}}
					 ...
					 {!! Form::submit(__('misc.approve'), ['class' => 'btn btn-success pull-right']) !!}
			...
			{!! Form::hidden('id', $data->id ); !!}
			{!! Form::button('<i class="bi-trash me-2"></i>'.__('misc.delete'), ['class' => 'btn btn-danger pull-right margin-separator actionDelete']) !!}
