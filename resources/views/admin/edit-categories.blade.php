...
<div class="content">
	<div class="row">
      ...
      @include('errors.errors-forms')
            ...
            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('admin.page_title') }}</label>
		          <div class="col-sm-10">
		            <input value="{{ $categories->page_title }}" name="page_title" type="text" class="form-control">
		          </div>
		        </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $categories->seo_title }}" name="seo_title" type="text" class="form-control">
		          </div>
		        </div>
            ...
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label text-lg-end">{{ __('admin.thumbnail') }} ({{__('misc.optional')}})</label>
              <div class="col-lg-5 col-sm-10">
                <div class="input-group mb-1">
                  <input name="thumbnail" type="file" class="form-control custom-file rounded-pill">
                </div>
                <small class="d-block">{{ __('admin.thumbnail_desc') }}</small>
              </div>
            </div>
