      ...
      @include('errors.errors-forms')
			...
			<div class="card shadow-custom border-0">
				<div class="card-body p-lg-5">
					 ...
					 <form method="post" action="{{ url('panel/admin/client-logos/add') }}" enctype="multipart/form-data">
             @csrf

		        <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('admin.client_name') }} <span class="text-danger">*</span></label>
		          <div class="col-sm-10">
		            <input value="{{ old('name') }}" name="name" required type="text" class="form-control" placeholder="e.g. OpenAI, Figma, Canva">
		          </div>
		        </div>

            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('admin.logo_image') }} <span class="text-danger">*</span></label>
		          <div class="col-lg-6 col-sm-10">
                <div class="input-group mb-1">
                  <input name="image" type="file" required accept="image/png,image/jpeg,image/webp,image/svg+xml" class="form-control custom-file rounded-pill" id="logoFileInput">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ old('website_url') }}" name="website_url" type="url" class="form-control" placeholder="https://example.com">
