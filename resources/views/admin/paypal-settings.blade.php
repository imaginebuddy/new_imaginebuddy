			...
			<div class="card shadow-custom border-0">
				<div class="card-body p-lg-5">
					...
					<form method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">{{ __('misc.fee') }}</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">{{ __('misc.fee_cents') }}</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Client ID</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Client Secret</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Webhook ID</label>
							<div class="col-sm-10">
								<input value="{{ $data->webhook_secret }}" name="webhook_secret" type="password"
									class="form-control">
								<p class="d-block">Webhook URL: <strong>{{ route('paypal.webhook') }}</strong></p>
							</div>
						</div>

						<fieldset class="row mb-3">
							<legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('admin.status') }}
							</legend>
							<div class="col-sm-10">
						...
						<fieldset class="row mb-3">
							...
							<div class="col-sm-10">
								<div class="form-check form-switch form-switch-md">
									<input class="form-check-input" type="checkbox" name="sandbox" @if ($data->sandbox
									== 'true') checked="checked" @endif value="true" role="switch">
								</div>
							</div>
						</fieldset>
