			...
			<div class="card shadow-custom border-0">
				<div class="card-body p-lg-5">
					...
					<form method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Razorpay Key ID</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Razorpay Key Secret</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Webhook Secret</label>
							<div class="col-sm-10">
								<input value="{{ $data->webhook_secret }}" name="webhook_secret" type="password" class="form-control">
								<small class="d-block"><a href="https://dashboard.razorpay.com/app/webhooks" target="_blank">https://dashboard.razorpay.com/app/webhooks</a></small>
							</div>
						</div>
						...
						<fieldset class="row mb-3">
							<legend class="col-form-label col-sm-2 pt-0 text-lg-end">Sandbox / Test Mode</legend>
							<div class="col-sm-10">
								<div class="form-check form-switch form-switch-md">
