      ...
      @include('errors.errors-forms')
			...
			<div class="card shadow-custom border-0">
				<div class="card-body p-lg-5">
					 ...
					 <form method="post" action="{{ url('panel/admin/faqs/add') }}">
             @csrf

		        <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('admin.question') }} <span class="text-danger">*</span></label>
		          <div class="col-sm-10">
		            <input value="{{ old('question') }}" name="question" required type="text" class="form-control" placeholder="e.g. How do I download high-resolution AI prompts?">
		          </div>
		        </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ old('category') }}" name="category" type="text" class="form-control" list="categoryOptions" placeholder="e.g. General, Licensing, Prompts, Billing">
                ...
                <small class="text-muted d-block mt-1">Optional. Groups related FAQs on the public page.</small>
		          ...
		          <div class="col-sm-10">
                <textarea class="form-control" name="answer" rows="6" id="content" required placeholder="Detailed response for this question...">{{ old('answer') }}</textarea>
