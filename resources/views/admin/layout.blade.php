            ...
            @if (auth()->user()->hasPermission('images'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/images') }}" class="nav-link text-truncate @if (request()->is('panel/admin/images')) active @endif">
                      ...
                      @if ($imagesPendingCount <> 0)
                      <span class="badge rounded-pill bg-warning text-dark me-1">{{ $imagesPendingCount }}</span>
                      @endif
                       {{ __('admin.images') }}
                  </a>
              </li><!-- /end list -->
              ...
              <li class="nav-item">
                  <a href="{{ url('panel/admin/photoshoots') }}" class="nav-link text-truncate @if (request()->is('panel/admin/photoshoot*')) active @endif">
                      <i class="bi-collection-play me-2"></i> Photoshoots
                  </a>
              </li><!-- /end list -->
              @endif
            ...
            @if (auth()->user()->hasPermission('members_reported'))
              ...
              <li class="nav-item">
                  <a href="{{ url('panel/admin/images-reported') }}" class="nav-link text-truncate @if (request()->is('panel/admin/images-reported')) active @endif">
                      ...
                      @if ($imagesReported <> 0)
                      <span class="badge rounded-pill bg-warning text-dark me-1">{{ $imagesReported }}</span>
                      @endif
