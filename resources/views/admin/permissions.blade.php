...
<div class="row mb-3">
	<div class="col-sm-10 offset-sm-2">
		<div class="form-check">
			<input class="form-check-input check" name="permissions[]" value="faqs" @if (isset($permissions) && in_array('faqs', $permissions)) checked="checked" @endif type="checkbox" id="faqs">
