...
<div class="content">
	<div class="row">
      ...
      <form method="POST" action="{{ url('panel/admin/settings') }}" enctype="multipart/form-data">
       ...
       <div class="row mb-3">
         <label class="col-sm-2 col-form-label text-lg-end">AI Models</label>
         <div class="col-sm-10">
           <input type="text" value="{{ $settings->ai_models ?? 'Nano Banana, Midjourney, GPT Image, Flux, Gemini, Other' }}" name="ai_models" class="form-control">
           <small class="d-block text-muted mt-1">* Enter AI model names separated by comma (e.g. Nano Banana, Midjourney, GPT Image, Flux, Gemini, Other). These will appear in the prompt upload dropdown.</small>
         </div>
       </div><!-- end row -->
