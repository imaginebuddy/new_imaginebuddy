...
Route::get('members',[HomeController::class, 'members']);
 ...
 // Photoshoots
 Route::get('photoshoots', [HomeController::class, 'photoshoots']);
 Route::get('photoshoots/{slug}', [HomeController::class, 'photoshootDetail']);
...
// Prompt Details
Route::get('prompt/{slug}',[ImagesController::class, 'show'])->name('prompt.show');
Route::get('prompt/{id}/{slug?}',[ImagesController::class, 'showLegacyRedirect'])->where('id', '[0-9]+');
Route::get('photo/{id}/{slug?}',[ImagesController::class, 'showLegacyRedirect'])->where('id', '[0-9]+');
...
Route::get('ajax/copied', [AjaxController::class, 'copied']);
...
Route::group(['middleware' => 'auth'], function() {
	...
	//<---- Bulk Upload
	Route::get('bulk-upload', [BulkUploadController::class, 'bulkUpload'])->name('bulk_upload');
	...
	Route::match(['get', 'post'], 'subscription/stock/{token_id}', [ImagesController::class, 'subscriptionDownload']);
	...
	// Razorpay Routes
	Route::get('payment/razorpay/subscription', [\App\Http\Controllers\RazorpayController::class, 'showSubscription'])->name('razorpay.subscription');
	Route::post('razorpay/subscription/process', [\App\Http\Controllers\RazorpayController::class, 'processSubscription']);
...
Route::group(['middleware' => 'downloads'], function() {
	Route::match(['get', 'post'], 'download/stock/{token_id}', [ImagesController::class, 'download']);
});
...
Route::group(['middleware' => 'role'], function() {
	...
	// Photoshoots
	Route::get('panel/admin/photoshoots', [AdminController::class, 'photoshoots'])->name('photoshoots');
	Route::get('panel/admin/photoshoots/add', [AdminController::class, 'createPhotoshoot'])->name('photoshoots');
	Route::post('panel/admin/photoshoots/add', [AdminController::class, 'storePhotoshoot']);
	Route::get('panel/admin/photoshoots/edit/{id}', [AdminController::class, 'editPhotoshoot'])->name('photoshoots');
	Route::post('panel/admin/photoshoots/update', [AdminController::class, 'updatePhotoshoot']);
	Route::post('panel/admin/photoshoots/delete/{id}', [AdminController::class, 'deletePhotoshoot']);
	Route::get('panel/admin/photoshoots/search-prompts', [AdminController::class, 'searchPromptsForPhotoshoot']);
	Route::post('panel/admin/photoshoots/add-prompt', [AdminController::class, 'addPromptToPhotoshoot']);
	Route::post('panel/admin/photoshoots/remove-prompt', [AdminController::class, 'removePromptFromPhotoshoot']);
